...
country = {
	...
	GOLD_TO_WORKER_PAY_RATE = 0.5, -- Multiplier for how much money gold pays to pops
...
economy = {
	...
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 250000,
	MAX_LOAN_CAP_FROM_BANKS = 4000, -- can loan max % of country tax base from single country
	...
	FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.15, -- % of how much we pay to the pops and capitalists, from the leftovers.
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 5.0,	-- how fast pops are Hired when there is a high demand
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 2.5,	-- how fast pops are Hired when there is a medium demand
...
military = {
	...
	AI_ARMY_TAXBASE_FRACTION = 0.35, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
	AI_NAVY_TAXBASE_FRACTION = 0.25, -- max of tax base that AI will spend on navy supply costs (based on peacetime costs)
	AI_BLOCKADE_RANGE = 9000, -- max distance the AI will send out blockade fleets from their home base
...
pops = {
	...
	MIL_REQUIRE_REFORM = 0.25,
	MIL_IDEOLOGY = -0.05,
	MIL_RULING_PARTY = -0.3,
	MIL_REFORM_IMPACT = 5,
	MIL_WAR_EXHAUSTION = 0.002,
	MIL_NON_ACCEPTED = 0.01, -- TODO 0.05
	...
	LUXURY_CON_CHANGE = 0.01, -- con boost from over-buying luxuary goods
